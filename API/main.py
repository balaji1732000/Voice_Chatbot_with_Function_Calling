...
function_description = [
    {
        ...
        "description": "categories & extract key info from an email, such as use case, company etc.",
        "parameters": {
            "type": "object",
            "properties": {
                "companyName": {
                ...
                "product": {
                    "type": "string",
                    "description": "Try to identify which product the client is interested, if any",
                },
                "amount": {
                    "type": "string",
                ...
                "category": {
                    "type": "string",
                    "description": "Try to categorise this email into categories like those: 1. Sale; 2. Customer Support; 3.consulting; 4. partnership; etc.",
                },
                "nextStep": {
                    "type": "string",
...
def analyse_email(email: Email):
    ...
    query = f"Please extract key information from the this email: {content}"
