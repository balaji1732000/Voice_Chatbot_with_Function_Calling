...
__all__ = [
    'SRTEmulated', 'DISPID_SVSPhonemeId',
    'DISPID_SRSetPropertyNumber', 'DISPID_SLPsItem', 'SPPS_LMA',
    'SpeechVisemeFeature', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPEI_RESERVED1', 'SP_VISEME_19', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SVESentenceBoundary', 'SPSLMA',
    ...
    'SpObjectTokenCategory', 'SPRST_ACTIVE', 'SGDisplay',
    'SRAInterpreter', 'DISPID_SGRSTRule', 'DISPID_SVEBookmark',
    'STCInprocHandler', 'SAFTADPCM_11kHzStereo', 'SRESoundEnd',
    'SpeechWordPronounceable', 'eLEXTYPE_PRIVATE2',
    'DISPID_SpeechObjectToken', 'IEnumString', 'ISpRecoGrammar',
    'DISPID_SRCEBookmark', 'SRSEIsSpeaking',
    'DISPID_SLAddPronunciation', 'DISPID_SVGetProfiles', 'SpVoice',
    'SRTSMLTimeout', 'DISPID_SpeechGrammarRules',
    'DISPID_SRCERecognizerStateChange', 'SpeechVoiceSkipTypeSentence',
    'eLEXTYPE_PRIVATE1', 'DISPID_SPEsCount', 'SPRECOCONTEXTSTATUS',
    'SGDSInactive', 'SAFTCCITT_uLaw_8kHzStereo', 'SECFIgnoreCase',
    'DISPID_SGRSRule', 'SpNotifyTranslator',
    'DISPID_SPPNumberOfElements', 'DISPID_SPEAudioSizeTime',
    'DISPID_SASCurrentSeekPosition', 'SpeechVoiceSpeakFlags',
    'SRTAutopause', 'DISPID_SpeechAudioStatus', 'SPSERIALIZEDRESULT',
    'SPSHT_EMAIL', 'SAFT22kHz16BitMono', 'SVEPhoneme',
    'SpeechAudioFormatType', 'SGRSTTWildcard',
    'DISPID_SRRSetTextFeedback', 'SPEI_HYPOTHESIS', 'SWTDeleted',
    'DISPID_SPPsCount', 'SPPHRASEELEMENT', 'DISPID_SPAsItem',
    'SP_VISEME_16', 'SDA_Consume_Leading_Spaces',
    'DISPID_SDKEnumKeys', 'DISPID_SRGSetTextSelection',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SGRAttributes',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SGRsCommit', 'SVP_1',
    'SpUnCompressedLexicon', 'DISPID_SPIProperties',
    'DISPID_SCSBaseStream', 'SECNormalConfidence',
    'DISPID_SLGenerationId', 'DISPID_SPRsCount', 'SPBO_NONE',
    'SVPAlert', 'DISPID_SpeechVoiceStatus', 'DISPID_SPRulesItem',
    'DISPID_SPRules_NewEnum', 'DISPID_SABufferInfo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPRuleConfidence', 'DISPID_SVStatus', 'SREBookmark',
    'SPFILEMODE', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseInfo', 'SPPS_RESERVED3',
    'DISPID_SPELexicalForm', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVSFParseSapi',
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_RESERVED10', 'SASClosed',
    'DISPID_SPRuleChildren', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SPEEngineConfidence', 'DISPID_SAFSetWaveFormatEx',
    'SpeechPropertyResponseSpeed', 'SPINTERFERENCE_NOISE',
    'DISPID_SMSGetData', 'ISpRecoContext', 'SAFT22kHz16BitStereo',
    'SpMMAudioIn', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRRTLength', 'SPSTREAMFORMATTYPE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SP_VISEME_2', 'SPSVerb',
    'SINoSignal', 'DISPID_SpeechFileStream',
    'DISPIDSPTSI_SelectionLength', 'SDTAudio',
    'SPEI_SR_RETAINEDAUDIO', 'SWPUnknownWordUnpronounceable',
    'SPSMF_SAPI_PROPERTIES', 'STCInprocServer', 'SPINTERFERENCE_NONE',
    'SPVPRI_ALERT', 'SDKLLocalMachine', 'DISPID_SRCERecognition',
    'DISPID_SRGDictationSetState', 'SPEI_END_SR_STREAM',
    'SPXMLRESULTOPTIONS', 'SRERecognition', 'DISPID_SVAudioOutput',
    'SpStreamFormatConverter', 'SVF_None',
    'DISPID_SRCEFalseRecognition', 'SpeechGrammarTagWildcard',
    'DISPID_SpeechMMSysAudio', 'SPEI_SOUND_END',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SpeechVoiceEvent',
    'DISPID_SPCIdToPhone', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPIAudioSizeBytes', 'SAFT48kHz16BitMono', 'SRARoot',
    'SDTAll', 'ISpStreamFormat', 'Speech_Max_Word_Length',
    'SAFTCCITT_ALaw_11kHzStereo', 'SP_VISEME_18',
    'DISPID_SLPs_NewEnum', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SMSSetData', 'ISpEventSink',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPAPhraseInfo', 'SAFT24kHz8BitMono',
    'DISPID_SRRPhraseInfo', 'SPEI_END_INPUT_STREAM',
    'ISpeechPhraseRules', 'SVEBookmark', 'ISpeechCustomStream',
    'ISpeechRecognizerStatus', 'DISPID_SRRRecoContext',
    'ISpPhoneticAlphabetConverter', 'DISPID_SLPSymbolic',
    'SpWaveFormatEx', 'SPSMF_UPS', 'SVSFIsFilename',
    'SPPS_Interjection', 'DISPID_SPPEngineConfidence',
    'DISPID_SLWWord', 'SpeechWordType', 'DISPID_SPCLangId',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPRs_NewEnum',
    'DISPID_SPEActualConfidence', 'SPGS_DISABLED', 'SDTDisplayText',
    'SVSFParseSsml', 'DISPID_SVGetVoices', 'DISPID_SGRSTWeight',
    'eLEXTYPE_PRIVATE5', 'DISPID_SOTIsUISupported',
    'SDA_No_Trailing_Space', 'DISPID_SPAs_NewEnum', 'SPPS_RESERVED4',
    'SGLexical', 'SPPHRASEPROPERTY', 'DISPID_SRGReset',
    'ISpeechXMLRecoResult', 'ISpeechGrammarRule',
    ...
    'SRERecoOtherContext', 'SGRSTTWord', 'SPWORDPRONUNCIATION',
    'eLEXTYPE_PRIVATE14', 'DISPID_SPEPronunciation',
    'SAFT11kHz16BitStereo', 'DISPID_SRCERequestUI',
    'eLEXTYPE_PRIVATE19', 'DISPID_SLGetPronunciations',
    'eWORDTYPE_ADDED', 'DISPID_SVWaitUntilDone', 'ISpPhraseAlt',
    'SVP_13', 'ISpeechResourceLoader', 'SpeechMicTraining',
    'DISPID_SRCVoice', 'DISPID_SpeechRecoResult', 'SPPS_Unknown',
    'DISPID_SPIStartTime', 'SAFT32kHz8BitStereo', 'DISPID_SASetState',
    'eLEXTYPE_PRIVATE9', 'DISPID_SDKOpenKey',
    'DISPID_SADefaultFormat', 'SVPOver', 'eLEXTYPE_PRIVATE17',
    'DISPID_SPIRule', 'SVP_10', 'SpPhoneticAlphabetConverter',
    'DISPID_SRCEAudioLevel', 'eLEXTYPE_PRIVATE15', 'SpeechTokenKeyUI',
    'SRERequestUI', 'SAFT12kHz8BitMono', 'SPAR_High',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SVIsUISupported',
    'ISpeechRecoResult', 'SPRECORESULTTIMES', 'SpResourceManager',
    'DISPID_SVGetAudioInputs', 'SVSFIsNotXML',
    'DISPID_SVAudioOutputStream', 'ISpeechPhraseReplacements',
    'SAFTText', 'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRCESoundEnd',
    'SP_VISEME_21', 'SDTRule', 'SVSFPersistXML',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SVSVisemeId',
    'ISpObjectToken', 'DISPID_SpeechGrammarRule', 'DISPIDSPTSI',
    'DISPID_SRSetPropertyString', 'DISPID_SGRAddState',
    'ISpeechRecoResultTimes', 'DISPID_SVEViseme',
    'SAFT44kHz16BitStereo', 'ISpeechRecoResult2',
    'ISpObjectTokenCategory', 'ISpLexicon',
    'DISPID_SDKSetStringValue', 'DISPID_SRCEInterference',
    'SPEI_WORD_BOUNDARY', 'SpeechFormatType', 'ISpeechWaveFormatEx',
    'SPSNotOverriden', 'DISPID_SPIElements',
    ...
    'DISPID_SRCBookmark', 'LONG_PTR', 'SRADynamic',
    'SPBOOKMARKOPTIONS', 'SLODynamic', 'DISPID_SpeechBaseStream',
    'eLEXTYPE_PRIVATE7', 'DISPID_SpeechPhraseRules',
    'eLEXTYPE_RESERVED9', 'IStream', 'DISPID_SPPValue',
    'DISPID_SDKEnumValues', 'SREAdaptation',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVSLastBookmarkId',
    'DISPID_SVEEnginePrivate', 'SPAUDIOOPTIONS', 'SpeechTokenContext',
    'DISPID_SRCEPropertyStringChange', 'SRATopLevel', 'SPCT_COMMAND',
    'SPDKL_CurrentConfig', 'SINone', 'DISPID_SGRSTPropertyName',
    'SPPROPERTYINFO', 'DISPID_SRGRecoContext', 'SRSActiveAlways',
    'SAFTGSM610_11kHzMono', 'ISpPhoneticAlphabetSelection',
    'DISPID_SLWs_NewEnum', 'SPEVENTENUM',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SPIReplacements',
    'DISPID_SpeechVoice', 'SVPNormal',
    'DISPID_SRCEPropertyNumberChange', 'SVSFParseAutodetect',
    '_ISpeechRecoContextEvents', 'DISPID_SpeechLexiconWord',
    'SpeechRecoEvents', 'SVSFVoiceMask', 'SDKLDefaultLocation',
    'SpPhraseInfoBuilder', 'eLEXTYPE_RESERVED8',
    'SAFTCCITT_ALaw_8kHzMono', 'SGSEnabled', 'DISPID_SGRInitialState',
    'DISPID_SGRSAddWordTransition', 'SpeechAudioFormatGUIDText',
    'SP_VISEME_15', 'SREPrivate', 'DISPID_SRSAudioStatus',
    'SpCompressedLexicon', 'DISPID_SRCResume', 'SPSHORTCUTPAIRLIST',
    'ISpNotifySink', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechPhraseElement', 'SRESoundStart',
    'ISpeechPhraseInfo', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SLWPronunciations',
    'SPGS_EXCLUSIVE', 'DISPID_SRGSetWordSequenceData',
    'eLEXTYPE_PRIVATE4', 'ISpRecognizer3', 'DISPID_SGRSTsItem',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPPsItem',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRRDiscardResultInfo',
    'SpeechEngineConfidence', 'DISPID_SGRAddResource',
    'SPINTERFERENCE_TOOLOUD', 'SpCustomStream',
    'ISpeechPhraseReplacement', 'DISPID_SRRSaveToMemory',
    'SPPS_Function', 'SAFTGSM610_22kHzMono', 'SVSFParseMask',
    'DISPID_SPPConfidence', 'SPGRAMMARSTATE', 'DISPID_SGRId',
    'DISPID_SBSWrite', 'DISPID_SGRSTNextState', 'DISPID_SLWType',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPWORDLIST', 'SPXRO_SML',
    'SPCS_ENABLED', 'ISpeechPhraseAlternate', 'SPVPRI_OVER',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SVEVoiceChange',
    'DISPID_SRCEAdaptation', 'DISPID_SLPLangId', 'SpPhoneConverter',
    'SVSFDefault', 'SpeechRunState', 'SAFT11kHz8BitStereo',
    'SPFM_CREATE', 'SAFTADPCM_11kHzMono', 'DISPID_SWFEFormatTag',
    '_RemotableHandle', 'DISPID_SPIEnginePrivateData',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SGRsDynamic',
    'DISPID_SPRuleParent', 'SVEStartInputStream',
    'DISPID_SpeechObjectTokens', 'SPWORDTYPE', 'DISPID_SVSpeakStream',
    'SpAudioFormat', 'SPPHRASEREPLACEMENT', 'SAFT8kHz16BitStereo',
    'SSFMCreateForWrite', 'SPBO_PAUSE', 'DISPID_SRGCmdLoadFromFile',
    'SpeechVisemeType', 'DISPID_SVSLastResult',
    'DISPID_SpeechPhraseProperty', 'SP_VISEME_11',
    'ISpeechAudioStatus', 'Speech_StreamPos_Asap', 'SGSExclusive',
    'DISPID_SWFESamplesPerSec', 'ISpRecoGrammar2', 'SPEI_RESERVED6',
    'SpShortcut', 'SPSHORTCUTTYPE', 'DISPID_SpeechAudioFormat',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechAudio', 'eLEXTYPE_APP',
    'SPRECOGNIZERSTATUS', 'ISpeechPhoneConverter',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechCustomStream', 'DISPID_SWFEBlockAlign',
    'SPAR_Medium', 'SPAO_RETAIN_AUDIO', 'SAFT8kHz8BitMono',
    'SPSFunction', 'ISpeechDataKey', 'SAFT12kHz16BitMono',
    'eLEXTYPE_PRIVATE6', 'SPBO_TIME_UNITS', '__MIDL_IWinTypes_0009',
    'SPFM_OPEN_READWRITE', 'SP_VISEME_10',
    'DISPID_SPRDisplayAttributes', 'SVEAudioLevel', 'SPCT_SLEEP',
    'SPAO_NONE', 'SpeechGrammarWordType', 'SPEVENTSOURCEINFO',
    'DISPID_SDKGetStringValue', 'SITooSlow', 'SRAORetainAudio',
    'DISPID_SVAlertBoundary', 'SpeechDiscardType',
    'DISPID_SLRemovePronunciation', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechDisplayAttributes', 'SPSSuppressWord', 'SREStreamEnd',
    'DISPID_SGRSTType', 'DISPID_SGRClear', 'SVP_12',
    'DISPID_SVSInputSentencePosition', 'DISPIDSPTSI_ActiveLength',
    'SINoise', 'ISpeechAudioFormat', 'SpeechEngineProperties',
    'SVP_0', 'SPEI_SOUND_START', 'SVP_3', 'DISPID_SGRsFindRule',
    'DISPID_SLWsItem', 'SVP_20', 'SRADefaultToActive', 'SVEPrivate',
    'SpeechGrammarTagDictation', 'SPCT_DICTATION',
    'DISPID_SPCPhoneToId', 'tagSTATSTG', 'SRSInactive',
    'SAFTGSM610_8kHzMono', 'SRCS_Enabled', 'SVP_6',
    'DISPID_SRSCurrentStreamNumber', 'SpeechUserTraining',
    'DISPID_SRGCmdLoadFromResource', 'SPCT_SUB_COMMAND',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPPFirstElement', 'ISpeechRecoResultDispatch', 'SVP_7',
    'DISPID_SDKDeleteKey', 'DISPID_SOTDisplayUI', 'SAFT16kHz8BitMono',
    'DISPID_SRCCreateResultFromMemory', 'DISPIDSPTSI_SelectionOffset',
    'STCLocalServer', 'DISPIDSPRG', 'DISPID_SpeechPhraseProperties',
    'SPSEMANTICFORMAT', 'SREHypothesis', 'SPEI_TTS_PRIVATE',
    'SGDSActiveUserDelimited', 'eLEXTYPE_MORPHOLOGY',
    'SpeechCategoryAudioIn', 'SAFTADPCM_44kHzStereo',
    'SpeechGrammarState', 'SpeechTokenShellFolder', 'DISPID_SPPId',
    'DISPID_SRRTTickCount', 'ISpNotifySource', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechPhraseAlternates', 'ISpeechLexiconPronunciations',
    'SPVPRIORITY', 'SVP_14', 'DISPID_SRRSpeakAudio',
    'DISPID_SDKDeleteValue', 'SRAExport',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRRTimes', 'SRSActive',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SOTs_NewEnum',
    'DISPID_SRRecognizer', 'IEnumSpObjectTokens',
    'DISPID_SDKCreateKey', 'SpeechPartOfSpeech',
    'DISPID_SpeechLexiconProns', 'DISPID_SOTCId', 'SPWT_DISPLAY',
    'ISpEventSource', 'SVP_11', 'SP_VISEME_0',
    'DISPID_SVSInputWordLength', 'SECFDefault', 'SPVPRI_NORMAL',
    'ISpeechGrammarRules', 'SpeechPropertyResourceUsage',
    'DISPID_SRGCmdLoadFromMemory', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_PRIVATE18', 'SAFT24kHz16BitMono', 'DISPID_SRGCommit',
    'SASPause', 'SPDATAKEYLOCATION', 'SAFT8kHz16BitMono',
    'SPEI_MAX_SR', 'DISPID_SVEAudioLevel',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPINTERFERENCE_NOSIGNAL',
    'SPDKL_DefaultLocation', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SLWLangId', 'SRAONone',
    'ISpeechGrammarRuleStateTransition', 'SpObjectToken',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRRGetXMLResult',
    'SpeechDataKeyLocation', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRState', 'SVSFlagsAsync', 'SpeechRecoContextState',
    'SREStateChange', 'SPSModifier', 'DISPID_SPPParent',
    'DISPID_SPIGetDisplayAttributes', 'SPRST_ACTIVE_ALWAYS',
    'SPCATEGORYTYPE', 'DISPID_SPIAudioStreamPosition',
    'SpeechAllElements', 'SAFT48kHz8BitMono',
    'DISPID_SVSLastBookmark', 'SpMMAudioOut', 'SpeechAudioVolume',
    'SP_VISEME_12', 'DISPID_SPIGrammarId', 'SPEI_MIN_TTS',
    'ISpPhrase', 'SDTLexicalForm', 'DISPID_SPERetainedSizeBytes',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SGRSTs_NewEnum',
    'SpeechPropertyAdaptationOn', 'SPAS_PAUSE', 'DISPID_SPRulesCount',
    'tagSPPROPERTYINFO', 'DISPID_SpeechMemoryStream',
    'SVSFPurgeBeforeSpeak', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SAVolume', 'DISPID_SpeechDataKey', 'ISpeechMemoryStream',
    'SGLexicalNoSpecialChars', 'DISPID_SPERequiredConfidence',
    'Speech_Max_Pron_Length', 'SpeechAudioFormatGUIDWave',
    'SPPS_Noncontent', 'DISPID_SPRuleId', 'SECFIgnoreKanaType',
    'DISPID_SpeechGrammarRuleState', 'SAFT22kHz8BitMono',
    'SPSHT_Unknown', 'DISPID_SGRSTsCount', 'DISPID_SBSRead',
    'SpNullPhoneConverter', 'DISPID_SLPPhoneIds', 'DISPID_SPIGetText',
    'DISPID_SPAsCount', 'ISpeechVoice', 'SPEI_RECOGNITION',
    'ISpDataKey', 'SPEI_MAX_TTS', 'eLEXTYPE_USER',
    'SAFT8kHz8BitStereo', 'SPPS_RESERVED2', 'SPEI_FALSE_RECOGNITION',
    'SPRST_INACTIVE', 'SpeechRecognitionType', 'SVEViseme',
    'SpStream', 'SpMemoryStream', 'SRCS_Disabled',
    'SpeechCategoryRecoProfiles', 'SPRS_INACTIVE',
    'eLEXTYPE_VENDORLEXICON', 'ISequentialStream', 'DISPID_SOTsItem',
    'DISPID_SRGetFormat', 'DISPID_SVEStreamEnd',
    'DISPID_SRCEPhraseStart', 'SBONone', 'DISPID_SPPName',
    'SVF_Stressed', 'SVP_15', 'SpeechPropertyLowConfidenceThreshold',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SRCCreateGrammar',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SVSFUnusedFlags',
    'DISPID_SRCRequestedUIType', 'SVESentenceBoundary',
    'DISPID_SVEventInterests', 'DISPID_SABufferNotifySize',
    'DISPID_SpeechWaveFormatEx', 'SPBO_AHEAD', 'DISPID_SASState',
    'ISpeechLexiconPronunciation',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFTNonStandardFormat',
    'DISPID_SGRSTText', 'ISpSerializeState', 'SPPS_Noun', 'ISpAudio',
    'DISPID_SVSRunningState', 'SPAUDIOSTATE',
    'ISpeechGrammarRuleState', 'SPWF_SRENGINE', 'eLEXTYPE_PRIVATE10',
    'SPAS_CLOSED', 'SREFalseRecognition', 'SSTTDictation',
    'DISPID_SVSInputWordPosition', 'SPRST_NUM_STATES',
    'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SLPPartOfSpeech', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SpeechPhraseReplacement', 'SAFT11kHz8BitMono',
    'SAFTADPCM_22kHzMono', 'SVP_18', 'DISPID_SDKSetLongValue',
    'SpeechTokenKeyFiles', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SOTCSetId',
    'DISPID_SABIBufferSize', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SMSAMMHandle', 'SpeechEmulationCompareFlags',
    'SGRSTTRule', 'DISPID_SRCVoicePurgeEvent', 'SGRSTTTextBuffer',
    'SVEAllEvents', 'SPEI_VOICE_CHANGE', 'DISPID_SpeechXMLRecoResult',
    'SpeechPropertyComplexResponseSpeed', 'SP_VISEME_13',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFT32kHz16BitStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPINTERFERENCE', 'SPEI_ADAPTATION', 'DISPID_SVVoice',
    'DISPID_SRSSupportedLanguages', 'ISpPhoneConverter',
    'DISPID_SRIsShared', 'SPBINARYGRAMMAR', 'DISPID_SVRate',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SVSInputSentenceLength',
    'SREStreamStart', 'ISpeechMMSysAudio', 'SPRS_ACTIVE', 'SWTAdded',
    'SECHighConfidence', 'DISPID_SPIAudioSizeTime',
    'eLEXTYPE_RESERVED7', 'ISpeechPhraseAlternates', 'SPLO_DYNAMIC',
    'ISpeechRecoGrammar', 'SREPropertyStringChange', 'SRAImport',
    'DISPID_SGRSTransitions', 'DISPID_SpeechRecoContextEvents',
    'ISpResourceManager', 'DISPID_SGRName', 'DISPID_SOTId', 'SPEVENT',
    'SPEI_VISEME', 'DISPID_SRRAudioFormat',
    'SWPKnownWordPronounceable', 'SpeechSpecialTransitionType',
    'SPAR_Low', 'DISPID_SASNonBlockingIO', 'SPRULESTATE',
    'ISpeechAudio', 'SAFT16kHz8BitStereo', 'SPDKL_CurrentUser',
    'SPSHORTCUTPAIR', 'DISPID_SMSADeviceId',
    'DISPID_SRCEventInterests', 'SREPhraseStart',
    'DISPID_SpeechRecognizer', 'DISPID_SAFGuid', 'SVEWordBoundary',
    'DISPID_SBSSeek', 'SpeechVoiceEvents', 'SASStop',
    'ISpeechLexiconWords', 'DISPID_SRGDictationLoad',
    'DISPID_SRCEStartStream', 'SpeechRegistryUserRoot',
    'DISPID_SVGetAudioOutputs', 'SPSNoun',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SRCEEndStream',
    'SAFTADPCM_22kHzStereo', 'SSFMOpenForRead',
    'SSSPTRelativeToStart', 'DISPID_SASFreeBufferSpace',
    'SP_VISEME_6', 'SAFTGSM610_44kHzMono', 'ISpRecoContext2',
    'DISPID_SRCESoundStart', 'DISPID_SOTRemoveStorageFileName',
    'STSF_FlagCreate', 'SVP_21', 'SAFTCCITT_uLaw_44kHzStereo',
    'SDA_Two_Trailing_Spaces', 'DISPID_SPRFirstElement',
    'DISPID_SGRSTPropertyId', 'DISPID_SGRsCommitAndSave',
    'ISpeechRecognizer', 'DISPID_SRDisplayUI', 'SDTPronunciation',
    'SpeechAudioProperties', 'SSFMCreate', 'eLEXTYPE_PRIVATE8',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPILanguageId',
    'DISPID_SRGDictationUnload', 'SLTApp', 'SPAS_STOP',
    'DISPID_SRStatus', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPEI_UNDEFINED', 'SECFIgnoreWidth', 'SITooLoud', 'SSTTWildcard',
    'SPPS_RESERVED1', 'SPAUDIOBUFFERINFO', 'SAFT16kHz16BitMono',
    'DISPID_SRAudioInputStream', 'SVP_17',
    'DISPID_SOTGetStorageFileName', 'DISPID_SOTsCount',
    'SPLOADOPTIONS', 'DISPID_SpeechPhraseAlternate',
    'SPCT_SUB_DICTATION', 'DISPID_SRGState', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRCEEnginePrivate', 'SPEI_PHONEME',
    'SpeechVoiceCategoryTTSRate', 'SPPHRASE',
    'DISPID_SRGetPropertyNumber', 'SPADAPTATIONRELEVANCE',
    'SPEI_RESERVED2', 'SP_VISEME_3', 'DISPID_SRAudioInput',
    'DISPID_SRGCmdSetRuleState', 'ISpeechBaseStream',
    'ISpeechPhraseInfoBuilder', 'DISPID_SLPType',
    'SpeechStreamSeekPositionType', 'SWPUnknownWordPronounceable',
    'SSFMOpenReadWrite', 'DISPID_SWFEBitsPerSample',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpProperties',
    'SpeechRetainedAudioOptions', 'DISPID_SPRText',
    'SPPS_SuppressWord', 'ISpRecoCategory', 'ISpeechRecoContext',
    'SPWAVEFORMATTYPE', 'SpLexicon', 'SPGRAMMARWORDTYPE',
    'ISpeechAudioBufferInfo', 'SGPronounciation',
    'DISPID_SpeechPhraseElements', 'UINT_PTR', 'DISPID_SABIEventBias',
    'STSF_LocalAppData', 'DISPID_SVEPhoneme', 'SPEI_RESERVED3',
    'ISpeechTextSelectionInformation', 'SpeechTokenValueCLSID',
    'SVF_Emphasis', 'SPAUDIOSTATUS', 'SAFTCCITT_ALaw_22kHzMono',
    'SPPS_Verb', 'DISPIDSPTSI_ActiveOffset', 'SDTProperty',
    'SAFTADPCM_8kHzStereo', 'DISPID_SWFEExtraData',
    'DISPID_SpeechLexiconWords', 'SPPARTOFSPEECH', 'SP_VISEME_1',
    'DISPID_SRRAudio', '_SPAUDIOSTATE', 'SPPS_Modifier',
    ...
    'DISPID_SVVolume', 'SPXRO_Alternates_SML',
    'ISpeechPhraseProperty', 'SAFTNoAssignedFormat',
    'SAFT11kHz16BitMono', 'DISPID_SAStatus', 'DISPID_SAFType',
    'SECLowConfidence', 'SRTExtendableParse',
    'DISPID_SOTCreateInstance', 'DISPID_SRRAlternates',
    'DISPID_SPEAudioTimeOffset', 'SpeechCategoryAudioOut',
    'SPEI_MIN_SR', 'SPPS_NotOverriden', 'SPSERIALIZEDPHRASE',
    'SpeechAddRemoveWord', 'SVEVoiceChange', 'SAFT12kHz16BitStereo',
    'DISPID_SOTGetAttribute', 'DISPID_SLGetWords',
    'DISPID_SRCEHypothesis', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRGetPropertyString', 'DISPID_SWFEChannels',
    'SGRSTTDictation', 'SVP_8', 'eLEXTYPE_USER_SHORTCUT',
    'SPEI_PHRASE_START', 'SP_VISEME_20', 'DISPID_SVResume',
    'DISPID_SVSkip', 'DISPID_SGRsItem', 'SPEI_TTS_AUDIO_LEVEL',
    'SDTReplacement', 'ISpMMSysAudio', 'SpeechInterference',
    'SLOStatic', 'SP_VISEME_17', 'ISpStream', '_ISpeechVoiceEvents',
    'SPPHRASERULE', 'SpInProcRecoContext', 'DISPID_SVEWord',
    'ISpVoice', 'DISPID_SMSALineId', 'ISpeechPhraseElement',
    'SDKLCurrentUser', 'SGRSTTEpsilon', 'ISpShortcut',
    'ISpeechPhraseRule', 'SPSHT_NotOverriden', 'ISpeechVoiceStatus',
    'DISPID_SpeechPhraseBuilder', 'SGDSActive', 'eLEXTYPE_PRIVATE3',
    'SpeechCategoryVoices', 'DISPID_SFSOpen', 'SAFT48kHz16BitStereo',
    'DISPID_SRCPause', 'SGSDisabled', 'WAVEFORMATEX', 'ISpRecoResult',
    'SRTReSent', 'SAFT24kHz8BitStereo', 'SVSFNLPSpeakPunc',
    'DISPID_SRCState', 'SVP_16', 'SPVOICESTATUS', 'SVP_9',
    'DISPID_SFSClose', 'ISpeechLexicon', 'STCRemoteServer',
    'SP_VISEME_8', 'SPAR_Unknown', 'SPEI_SR_PRIVATE',
    'DISPID_SDKGetlongValue', 'SREAllEvents', 'SVSFNLPMask',
    'DISPID_SPRuleFirstElement', 'ISpGrammarBuilder', 'SRSEDone',
    'SPEI_START_SR_STREAM', 'STSF_AppData', 'SAFT44kHz8BitStereo',
    'DISPID_SOTRemove', 'SREInterference',
    'DISPID_SPAStartElementInResult', 'DISPID_SpeechLexicon',
    'SPRECOSTATE', 'SAFT24kHz16BitStereo', 'SpMMAudioEnum',
    'SRSInactiveWithPurge', 'DISPID_SRRTStreamTime',
    'SVEEndInputStream', 'DISPID_SOTSetId', 'SPSHT_OTHER',
    'SP_VISEME_4', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRGIsPronounceable', 'DISPID_SRCRecognizer',
    'DISPID_SPRsItem', 'DISPID_SBSFormat', 'DISPID_SRGRules',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SpeechPhoneConverter', 'ISpeechObjectTokens',
    'DISPID_SPPs_NewEnum', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SRCreateRecoContext', 'SAFTCCITT_uLaw_22kHzMono',
    'SPRULE', 'SITooFast', 'SITooQuiet',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SLGetGenerationChange',
    'SP_VISEME_7', 'DISPID_SRCRetainedAudio', 'SASRun',
    'SPRST_INACTIVE_WITH_PURGE', 'SPEI_REQUEST_UI',
    'DISPID_SOTCDefault', 'ISpeechPhraseElements',
    'ISpeechLexiconWord', 'SpeechLoadOption', 'SPWF_INPUT',
    ...
    'SPLO_STATIC', 'DISPID_SOTCategory', 'SPCS_DISABLED',
    'ISpeechFileStream', 'SREPropertyNumChange',
    'DISPID_SDKSetBinaryValue', 'SPTEXTSELECTIONINFO',
    'SPFM_CREATE_ALWAYS', 'SVSFIsXML', 'SpSharedRecoContext',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechLexiconType', 'SPWORD',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SGRSAddRuleTransition',
    'SpeechCategoryAppLexicons', 'SAFTTrueSpeech_8kHz1BitMono',
    'eLEXTYPE_PRIVATE20', 'SVP_19', 'DISPID_SPEDisplayText',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SVPriority',
    'SAFTExtendedAudioFormat', 'DISPID_SPRuleNumberOfElements',
    'SBOPause', 'SVP_5', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SDKLCurrentConfig', 'SPGS_ENABLED', 'eLEXTYPE_RESERVED6',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SPEDisplayAttributes', 'SAFTADPCM_8kHzMono',
    'ISpRecognizer2', 'SpeechRuleState', 'SPSEMANTICERRORINFO',
    'SVP_2', 'SpeechRuleAttributes', 'Speech_StreamPos_RealTime',
    'DISPID_SABIMinNotification', 'ISpNotifyTranslator',
    'ISpeechObjectToken', 'SpeechBookmarkOptions', 'SP_VISEME_9',
    ...
    'SAFTCCITT_uLaw_8kHzMono', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SpeechRecoResult2', 'SECFEmulateResult',
    'DISPID_SpeechAudioBufferInfo', 'eLEXTYPE_PRIVATE11',
    'SAFT48kHz8BitStereo', 'DISPID_SVSpeak', 'DISPID_SAEventHandle',
    'SFTInput', 'SSTTTextBuffer', 'DISPID_SPISaveToMemory',
    'SPEI_RESERVED5', 'STCAll', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPARecoResult', 'DISPID_SPPChildren', 'SPCONTEXTSTATE',
    'SAFT16kHz16BitStereo', 'SAFTADPCM_44kHzMono', 'SRTStandard',
    'SVP_4', 'DISPID_SVEStreamStart',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT22kHz8BitStereo',
    'SPEI_INTERFERENCE', 'SpeechVoicePriority', 'SpSharedRecognizer',
    'SpFileStream', 'SPSUnknown', 'DISPID_SVPause',
    'ISpXMLRecoResult', 'SP_VISEME_5', 'DISPID_SOTGetDescription',
    'Speech_Default_Weight', 'SPAS_RUN', 'DISPID_SGRs_NewEnum',
    'DISPID_SVDisplayUI', 'DISPID_SRProfile', 'DISPID_SPEs_NewEnum',
    'ISpRecognizer', 'SpeechStreamFileMode', 'DISPID_SPIEngineId',
    'SPSInterjection', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SREmulateRecognition', 'SP_VISEME_14', 'SPVISEMES',
    'SAFT44kHz16BitMono', 'SAFT32kHz8BitMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SGRsAdd', 'SPLEXICONTYPE', 'DISPID_SpeechPhraseRule',
    'DISPID_SRGCmdLoadFromObject', 'SDTAlternates',
    'SPWT_PRONUNCIATION', 'SAFTDefault', 'SFTSREngine',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SLWsCount', 'SLTUser',
    'DISPID_SRGId', 'SPFM_NUM_MODES', 'DISPID_SDKGetBinaryValue',
    'DISPID_SGRsCount', 'IInternetSecurityManager',
    'DISPID_SLPsCount', 'DISPID_SOTDataKey', 'SAFT32kHz16BitMono',
    'DISPID_SPRuleName', 'SPWT_LEXICAL', 'DISPID_SRGetRecognizers',
